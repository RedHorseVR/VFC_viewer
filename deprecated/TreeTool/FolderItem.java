/**  C:\WINDOWS\Profiles\luis\Desktop\TreeTool\FolderItem.java  **/   //   FILE:C:\WINDOWS\Profiles\luis\Desktop\TreeTool\FolderItem.java...
...
void drawLineAcross(Graphics g, int xtop, int ytop, int xbot )  
  ...
  {  
    ...
    g.drawLine( xtop, ytop, xbot, ytop );  
...
void drawLineDown(Graphics g, int xtop, int ytop, int ybot )  
  ...
  {  
    ...
    g.drawLine( xtop, ytop, xtop, ybot);  
...
protected Item getPrev( int index, boolean expand )  
  ...
  {  
    ...
    try{  
      ...
      item =(Item)m_list.elementAt( index-1 );  
       //  // catch any error ...
      }  
...
protected Item getNext( int index, boolean expand )  
  ...
  try{  
    ...
    currItem =(Item)m_list.elementAt( index );  
...
//  FlowCode File: FolderItem.java.ins...
//  Export  File: FolderItem.java...
//  Export  Date: 02:45:44 AM - 30:Aug:1999...
